...
// // lib/app/modules/info_sekolah_detail/views/info_sekolah_detail_view.dart (FINAL & LENGKAP)
...
//   @override
//   Widget build(BuildContext context) {
//     // Pastikan locale 'id' untuk timeago sudah di-set di main.dart
...
//           // --- [PERBAIKAN KUNCI] Definisikan variabel di sini ---
//           final String judul = data['judul'] ?? 'Tanpa Judul';
//           final String imageUrl = data['imageUrl'] ?? '';
//           final String penulis = data['penulisNama'] ?? 'Admin';
//           final String jabatan = data['peranPenulis'] ?? 'Staf';
...
//                         )
//                       : Container(color: Colors.indigo.shade300),
//                 ),
//                 actions: [
//                   IconButton(
