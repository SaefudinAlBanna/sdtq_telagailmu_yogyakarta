...
//   @override
//   Widget build(BuildContext context) {
//     // Controller di-inject melalui file binding nanti
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Penunggak ${controller.jenisPembayaran}'),
//         centerTitle: true,
...
//             child: Text(
//               "Filter Kelas: ${controller.filterKelas}",
//               style: TextStyle(color: Colors.indigo.shade800.withOpacity(0.8)),
//             ),
//           ),
//         ),
//       ),
...
//               subtitle: Text("Kelas: ${siswa.namaKelasSimple}"),
//               trailing: Text(
//                 "Rp ${NumberFormat.decimalPattern('id_ID').format(siswa.totalTunggakan)}",
//                 style: const TextStyle(
//                   color: Colors.red,
//                   fontWeight: FontWeight.bold,
//                 ),
