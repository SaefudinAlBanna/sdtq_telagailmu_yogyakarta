...
// import 'package:sdtq_telagailmu_yogyakarta/app/models/tunggakan_siswa_model.dart';
...
//       // [PERBAIKAN] Tambahkan filter jatuh tempo di query HANYA untuk SPP
//       // Ini sangat efisien karena memfilter di sisi server
//       if (jenisPembayaran == 'SPP') {
//         query = query.where('tanggalJatuhTempo', isLessThan: Timestamp.now());
//       }
...
//           final idSiswa = data['idSiswa'] as String;
//           if (mapPenunggak.containsKey(idSiswa)) {
// //             // [PERBAIKAN 2] Gunakan .toInt() juga di sini saat akumulasi
//             mapPenunggak[idSiswa]!.totalTunggakan =
//                 (mapPenunggak[idSiswa]!.totalTunggakan + sisaTagihan).toInt();
//           } else {
//             mapPenunggak[idSiswa] = TunggakanSiswaModel(
//               uid: idSiswa,
//               namaSiswa: data['namaSiswa'] ?? 'Tanpa Nama',
...
//       final result = mapPenunggak.values.toList();
//       result.sort((a, b) => a.namaSiswa.compareTo(b.namaSiswa));
//       daftarPenunggak.assignAll(result);

//     } catch (e) {
//       Get.snackbar("Error", "Gagal mengambil rincian tunggakan: ${e.toString()}");
//       print("### Error Rincian Tunggakan: $e");
//     } finally {
//       isLoading.value = false;
//     }
//   }
