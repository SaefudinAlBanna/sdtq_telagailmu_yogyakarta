...
class EditorJadwalView extends GetView<EditorJadwalController> {
  ...
  Widget _buildPelajaranCard(Map<String, dynamic> pelajaran, int index) {
    // [PERBAIKAN #1] Obx yang besar di sini DIHAPUS.
    // Kita akan letakkan Obx yang lebih kecil di dalam.
            ...
            if (isKegiatanUmum)
              ...
              Column(
                children: [
                  ...
                  // [PERBAIKAN #2] Bungkus bagian yang reaktif dengan Obx yang lebih spesifik.
                  Obx(() {
                    // Cek jika mapel BUKAN halaqah.
                    if (pelajaran['idMapel'] != 'halaqah') {
                        ...
                        children: [
                          DropdownButtonFormField<String>(
                            ...
                            items: controller.guruDropdownList.where((g) {
                              // Jika "tampilkan semua" aktif, jangan filter.
                              if (controller.tampilkanSemuaGuru.value) return true;
                              // Jika tidak, tampilkan hanya guru yang ditugaskan untuk mapel ini.
                      ...
                      // Jika mapel ADALAH halaqah, tampilkan info Tim Tahsin.
                      return ListTile(
